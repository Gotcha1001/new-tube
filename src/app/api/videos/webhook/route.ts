  ...
  switch (payload.type as WebhookEvent["type"]) {
    ...
    case "video.asset.ready": {
      ...
      if (!uploadedThumbnail.data || !uploadedPreview.data) {
        return new Response("Failed to upload thumbnailor preview", {
          status: 500,
        });
      }
    ...
    case "video.asset.track.ready": {
      ...
      // Typesript incorrectly says that asset_id does not exist
...
//     switch (payload.type as WebhookEvent["type"]) {
//       case "video.asset.created": {
//         console.log("📹 Processing video.asset.created");
//         const data = payload.data as VideoAssetCreatedWebhookEvent["data"];
...
//         console.log("✅ Video asset created and updated");
//         break;
//       }

//       case "video.asset.ready": {
//         console.log("🎬 Processing video.asset.ready");
//         const data = payload.data as VideoAssetReadyWebhookEvent["data"];
//         const playbackId = data.playback_ids?.[0]?.id;
...
//       case "video.asset.errored": {
//         console.log("⚠️ Processing video.asset.errored");
//         const data = payload.data as VideoAssetErroredWebhookEvent["data"];
